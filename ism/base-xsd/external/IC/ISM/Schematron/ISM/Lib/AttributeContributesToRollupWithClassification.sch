...
<sch:pattern abstract="true" id="AttributeContributesToRollupWithClassification"
  ...
  <sch:p id="codeDesc">
    ...
    $resourceElementClassificationan element meeting ISM_CONTRIBUTES
    specifies attribute ism:$attrLocalName with a value containing the token
    [$value], then we make sure that the ISM_RESOURCE_ELEMENT specifies the 
