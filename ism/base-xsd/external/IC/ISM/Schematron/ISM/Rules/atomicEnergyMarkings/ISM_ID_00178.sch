...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00178" is-a="ValuesOrderedAccordingToCve"
  ...
  <sch:param name="attrValueTokens" value="tokenize(normalize-space(string(@ism:atomicEnergyMarkings)), ' ')"/>
