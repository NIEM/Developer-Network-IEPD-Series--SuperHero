...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00060" is-a="AttributeContributesToRollup" 
  ...
  <sch:param name="value" value="SI"/>
  <sch:param name="errorMessage" value="'[ISM-ID-00060][Error] USA documents having SI data must have SI at the resource level.'"/>
</sch:pattern>