...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00067" is-a="AttributeContributesToRollup" 
  ...
  <sch:param name="value" value="OC"/>
  <sch:param name="errorMessage" value="'[ISM-ID-00067][Error] USA documents having ORCON data must have ORCON at the resource level.'"/>
</sch:pattern>