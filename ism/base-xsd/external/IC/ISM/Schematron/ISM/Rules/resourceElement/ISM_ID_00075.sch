...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00075" is-a="AttributeContributesToRollup" 
  ...
  <sch:param name="errorMessage" value="'[ISM-ID-00075][Error] USA documents having Formerly Restricted Data (FRD) must have FRD at the resource level.'"/>
</sch:pattern>