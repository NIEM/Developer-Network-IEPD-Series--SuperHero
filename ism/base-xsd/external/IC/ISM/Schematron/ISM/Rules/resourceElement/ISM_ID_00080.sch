...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00080" is-a="AttributeContributesToRollup" 
  ...
  <sch:param name="value" value="DSEN"/>
  <sch:param name="errorMessage" value="'[ISM-ID-00080][Error] USA documents having DSEN Data must have DSEN at the resource level.'"/>
</sch:pattern>