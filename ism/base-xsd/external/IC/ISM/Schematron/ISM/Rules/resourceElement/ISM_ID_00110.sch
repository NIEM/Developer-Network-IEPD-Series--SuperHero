...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00110" is-a="NonCompilationDocumentRollup" 
  ...
  <sch:param name="value" value="C"/>
  <sch:param name="errorMessage" value="'[ISM-ID-00110][Error] USA C documents not using compilation must have C data.'"/>
</sch:pattern>
