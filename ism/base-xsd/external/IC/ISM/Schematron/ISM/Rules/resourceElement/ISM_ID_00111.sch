...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00111" is-a="NonCompilationDocumentRollup" 
  ...
  <sch:param name="errorMessage" value="'[ISM-ID-00111][Error] USA SI documents not using compilation must have SI data.'"/>
</sch:pattern>
