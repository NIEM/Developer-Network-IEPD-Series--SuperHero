...
<?ICEA pattern?> 
 <!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern id="ISM-ID-00116" is-a="NonCompilationDocumentRollup" 
  ...
  <sch:param name="errorMessage" value="'[ISM-ID-00116][Error] USA HCS documents not using compilation must have HCS data.'"/>
</sch:pattern>
